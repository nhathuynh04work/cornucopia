...
// Helper for the "Create New" buttons
						...
						>
							...
							<div className="p-5 flex-1 flex flex-col">
								...
								<div className="flex items-center gap-4 text-xs text-gray-500 mt-auto">
									<span>
										{course._count?.enrollments || 0} học
										viên
									</span>
				...
				renderItem={(deck) => (
					...
					>
						...
						<p className="text-xs text-gray-500 mt-auto">
							{/* Corrected: Use deck.cardsCount instead of deck._count.cards */}
				...
				renderItem={(post) => (
					...
					>
						<div className="h-32 w-full bg-gray-100 relative overflow-hidden">
							...
							<LibraryItemDelete
								onDelete={() => onDelete("bài viết", post.id)}
								itemName="bài viết"
				...
				<LibrarySection
					...
					renderItem={(test) => (
						...
						>
							...
							<p className="text-xs text-gray-500 mt-auto">
								{test._count?.attempts || 0} lượt thi • Cập nhật{" "}
