...
const AnswerOptionRow = ({ nestIndex, index, register, remove, handleToggleCorrect, control }) => {
...
export default function AnswerOptionsEditor({ nestIndex }) {
    ...
    const handleToggleCorrect = (index) => {
        fields.forEach((_, i) => {
            setValue(`items.${nestIndex}.answerOptions.${i}.isCorrect`, i === index);
        });
    };
    ...
    return (
        <div className="space-y-3">
            <div className="flex items-center justify-between mb-2">
                <p className="text-xs font-bold text-gray-500 uppercase tracking-wider">Các lựa chọn</p>
            </div>
