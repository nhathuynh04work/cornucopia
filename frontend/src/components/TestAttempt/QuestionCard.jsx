...
export default function QuestionCard({
	...
	return (
		<div
			ref={cardRef}
			className={cn(
				"bg-white rounded-2xl border transition-all duration-300 p-6 md:p-8 flex flex-col",
			...
			<div className="flex items-start justify-between gap-4 mb-4">
				...
				<button
					onClick={onFlag}
					className={cn(
						"flex-shrink-0 p-2.5 rounded-full transition-all border",
						isFlagged
				...
				{question.type === "SHORT_ANSWER" && (
					<div>
						<textarea
							...
							className="w-full p-4 rounded-xl border-2 border-gray-200 focus:border-purple-600 focus:ring-4 focus:ring-purple-500/10 transition-all outline-none min-h-[120px] text-gray-900 resize-none font-medium text-base"
						/>
					</div>
				)}
			</div>
